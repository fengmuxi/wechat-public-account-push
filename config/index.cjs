...
const USER_CONFIG = {
  ...
  USERS: [
    {
      ...
      id: 'oso6951Rxe5gZK9r_Z7bxq7_11tg',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'LolOUdlj8DvL3ASjiDiDpBmjd-jhn5AlzNJCZv7azfk',
      // 所在省份
      province: '江西',
      // 所在城市
      city: '南昌',
      ...
      festivals: [
        ...
        {
          type: '生日', name: '老婆', year: '2002', date: '12-18',
        },
        {
          type: '节日', name: '被搭讪纪念日', year: '3', date: '03-28',
        }
      ],
    ...
    },
    {
      ...
      name: '肖子莲',
      // 扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
      id: 'oso695xfCdJOtd0X9VToLCig87lA',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: '1jjDswb1fPKxd9Ja_S6lur0QvEcEqviM7xtR2xKH1zI',
      // 所在省份
      province: '江西',
      // 所在城市
      city: '九江',
      ...
      customizedDateList: [
        // 在一起的日子
        { keyword: 'love_day', date: '2000-06-01' }
      ],
      // 课程表相关配置
      // 如果courseSchedule不存在或者为空（null）则认为没有课程
      // 如果courseSchedule是一个数组，则认为不区分单双周，直接填写星期几对应的课表数据即可
  ...
  CALLBACK_TEMPLATE_ID: 'jhrz2x0uMBlp9Gz4AgQzoXw4rP-pJn8u_-b5iQXvVwM',
  ...
  CALLBACK_USERS: [
    {
      ...
      id: 'oso695z5tMsf8HVo0VJtNhTkYCJ4',
    }
    // 你可以不断按格式往下增加
    // ...
  ],
